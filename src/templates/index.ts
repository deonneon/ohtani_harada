...
export const availableTemplates: TemplateMetadata[] = [
  {
    ...
    description: 'Comprehensive development plan for aspiring professional athletes, inspired by Shohei Ohtani\'s Harada Method approach.',
    category: 'Sports',
    difficulty: 'advanced',
    estimatedHours: 2000,
  ...
  },
  {
    ...
    description: 'Strategic career development for technology professionals aiming for senior leadership positions.',
    category: 'Career',
  ...
  },
  {
    ...
    description: 'Complete academic success strategy for students pursuing honors and comprehensive skill development.',
    category: 'Education',
    difficulty: 'intermediate',
    estimatedHours: 1200,
  ...
  },
  {
    ...
    name: 'Life Mastery',
    description: 'Holistic personal development across physical, mental, emotional, and spiritual dimensions for life fulfillment.',
...
export function getTemplatesByCategory(category: string) {
  return availableTemplates.filter(t => t.category.toLowerCase() === category.toLowerCase());
}
