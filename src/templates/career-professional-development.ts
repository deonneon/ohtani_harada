...
export const careerProfessionalDevelopmentTemplate: MatrixData = {
  goal: {
    ...
    description:
      'Build a successful career in technology leadership through systematic skill development, networking, and strategic career planning following the Harada Method approach.',
  ...
  focusAreas: [
    {
      ...
      description:
        'Master technical skills and stay current with industry trends',
  ...
  tasks: [
    // Technical Expertise (8 tasks)
    {
      ...
      description:
        'Deepen expertise in primary technical domain and related technologies',
    ...
    },
    {
      ...
      description:
        'Follow technology trends, attend conferences, and read industry publications',
      areaId: 'area-technical-expertise',
      status: TaskStatus.PENDING,
      priority: TaskPriority.HIGH,
    },
    ...
    },
    {
      ...
      description:
        'Participate in open source projects to build portfolio and network',
      areaId: 'area-technical-expertise',
      status: TaskStatus.PENDING,
      priority: TaskPriority.MEDIUM,
    },
    {
      ...
      description:
        'Earn industry-recognized certifications to validate expertise',
      areaId: 'area-technical-expertise',
      status: TaskStatus.PENDING,
      priority: TaskPriority.MEDIUM,
    },
    ...
    },
    {
      ...
      description:
        'Share knowledge and help develop the next generation of professionals',
      areaId: 'area-technical-expertise',
      status: TaskStatus.PENDING,
    ...
    },
    {
      ...
      description:
        'Explore cutting-edge solutions and innovative approaches to problems',
      areaId: 'area-technical-expertise',
      status: TaskStatus.PENDING,
      priority: TaskPriority.LOW,
    },
    ...
    // Leadership Skills (8 tasks)
    {
      ...
      description:
        'Learn core management principles and team leadership basics',
    ...
    },
    {
      ...
      description:
        'Learn to effectively manage, motivate, and develop team members',
      areaId: 'area-leadership-skills',
      status: TaskStatus.PENDING,
      priority: TaskPriority.HIGH,
    },
    {
      ...
      description:
        'Develop skills to handle team conflicts and difficult conversations',
      areaId: 'area-leadership-skills',
      status: TaskStatus.PENDING,
      priority: TaskPriority.MEDIUM,
    },
    {
      ...
      description:
        'Master methodologies for planning, executing, and delivering projects',
      areaId: 'area-leadership-skills',
      status: TaskStatus.PENDING,
      priority: TaskPriority.MEDIUM,
    },
    {
      ...
      description:
        "Learn to coach and develop team members' skills and careers",
      areaId: 'area-leadership-skills',
      status: TaskStatus.PENDING,
      priority: TaskPriority.MEDIUM,
    },
    {
      ...
      description:
        'Develop ability to think strategically and make long-term decisions',
      areaId: 'area-leadership-skills',
      status: TaskStatus.PENDING,
      priority: TaskPriority.MEDIUM,
    },
    {
      ...
      description:
        'Create environment that encourages creativity and innovative thinking',
      areaId: 'area-leadership-skills',
      status: TaskStatus.PENDING,
      priority: TaskPriority.LOW,
    },
    {
      ...
      description:
        'Learn to manage and lead through periods of organizational change',
      areaId: 'area-leadership-skills',
      status: TaskStatus.PENDING,
      priority: TaskPriority.LOW,
    },
    ...
    // Business Acumen (8 tasks)
    {
      ...
      description:
        'Learn basic business concepts, financial statements, and metrics',
    ...
    },
    {
      ...
      description:
        'Gain deep understanding of industry dynamics and market forces',
      areaId: 'area-business-acumen',
      status: TaskStatus.PENDING,
      priority: TaskPriority.MEDIUM,
    },
    ...
    },
    {
      ...
      description:
        'Understand customer acquisition, sales processes, and marketing strategies',
      areaId: 'area-business-acumen',
      status: TaskStatus.PENDING,
      priority: TaskPriority.MEDIUM,
    },
    {
      ...
      description:
        'Master budgeting, forecasting, and financial decision making',
      areaId: 'area-business-acumen',
      status: TaskStatus.PENDING,
      priority: TaskPriority.MEDIUM,
    },
    ...
    },
    {
      ...
      description:
        'Develop deep understanding of customer needs and pain points',
      areaId: 'area-business-acumen',
      status: TaskStatus.PENDING,
      priority: TaskPriority.LOW,
    },
    ...
    // Career Strategy (8 tasks)
    {
      ...
      description:
        'Create clear vision for career progression and long-term goals',
    ...
    },
    {
      ...
      description:
        'Assess current skills and identify areas needing development',
      areaId: 'area-career-strategy',
      status: TaskStatus.PENDING,
      priority: TaskPriority.HIGH,
    },
    {
      ...
      description:
        'Develop detailed plan with milestones and timelines for advancement',
      areaId: 'area-career-strategy',
      status: TaskStatus.PENDING,
      priority: TaskPriority.HIGH,
    },
    ...
    },
    {
      ...
      description:
        'Take on challenging projects that demonstrate leadership potential',
      areaId: 'area-career-strategy',
      status: TaskStatus.PENDING,
      priority: TaskPriority.MEDIUM,
    },
    {
      ...
      description:
        'Document achievements and prepare compelling cases for advancement',
      areaId: 'area-career-strategy',
      status: TaskStatus.PENDING,
      priority: TaskPriority.MEDIUM,
    },
    ...
    // Communication (8 tasks)
    {
      ...
      description:
        'Master public speaking and presentation delivery techniques',
    ...
    },
    {
      ...
      description:
        'Enhance ability to write clear, concise, and compelling content',
      areaId: 'area-communication',
      status: TaskStatus.PENDING,
      priority: TaskPriority.MEDIUM,
    },
    {
      ...
      description:
        "Develop skills to truly listen and understand others' perspectives",
      areaId: 'area-communication',
      status: TaskStatus.PENDING,
      priority: TaskPriority.MEDIUM,
    },
    {
      ...
      description:
        'Develop communication style appropriate for leadership roles',
      areaId: 'area-communication',
      status: TaskStatus.PENDING,
      priority: TaskPriority.MEDIUM,
    },
    {
      ...
      description:
        'Learn to craft compelling narratives and tell stories effectively',
      areaId: 'area-communication',
      status: TaskStatus.PENDING,
      priority: TaskPriority.MEDIUM,
    },
    {
      ...
      description:
        'Master professional email writing and digital communication',
      areaId: 'area-communication',
      status: TaskStatus.PENDING,
      priority: TaskPriority.LOW,
    },
    {
      ...
      description:
        'Learn to communicate effectively across cultural and language barriers',
      areaId: 'area-communication',
      status: TaskStatus.PENDING,
      priority: TaskPriority.LOW,
    },
    {
      ...
      description:
        'Master giving and receiving constructive feedback effectively',
      areaId: 'area-communication',
      status: TaskStatus.PENDING,
      priority: TaskPriority.LOW,
    },
    ...
    // Networking (8 tasks)
    {
      ...
      description:
        'Establish connections with key industry professionals and leaders',
    ...
    },
    {
      ...
      description:
        'Participate in conferences, meetups, and professional gatherings',
      areaId: 'area-networking',
      status: TaskStatus.PENDING,
      priority: TaskPriority.MEDIUM,
    },
    ...
    },
    {
      ...
      description:
        'Identify and develop relationships with career mentors and sponsors',
      areaId: 'area-networking',
      status: TaskStatus.PENDING,
      priority: TaskPriority.MEDIUM,
    },
    {
      ...
      description:
        'Share knowledge through blogs, forums, and community involvement',
      areaId: 'area-networking',
      status: TaskStatus.PENDING,
      priority: TaskPriority.MEDIUM,
    },
    {
      ...
      description:
        'Organize and maintain professional contacts and relationships',
      areaId: 'area-networking',
      status: TaskStatus.PENDING,
      priority: TaskPriority.LOW,
    },
    {
      ...
      description:
        'Build comprehensive and professional LinkedIn profile and network',
      areaId: 'area-networking',
      status: TaskStatus.PENDING,
      priority: TaskPriority.LOW,
    },
    ...
    // Work-Life Balance (8 tasks)
    {
      ...
      description:
        'Establish clear work-life boundaries and prioritize personal time',
    ...
    },
    {
      ...
      description:
        'Cultivate personal interests and activities outside of work',
      areaId: 'area-work-life-balance',
      status: TaskStatus.PENDING,
      priority: TaskPriority.MEDIUM,
    },
    {
      ...
      description:
        'Incorporate meditation and mindfulness practices for stress management',
      areaId: 'area-work-life-balance',
      status: TaskStatus.PENDING,
      priority: TaskPriority.LOW,
    },
    ...
    },
    {
      ...
      description:
        'Develop network of friends and professionals for personal support',
      areaId: 'area-work-life-balance',
      status: TaskStatus.PENDING,
      priority: TaskPriority.LOW,
    },
    {
      ...
      description:
        'Recognize and celebrate personal achievements and life events',
      areaId: 'area-work-life-balance',
      status: TaskStatus.PENDING,
      priority: TaskPriority.LOW,
    },
    ...
    // Continuous Learning (8 tasks)
    {
      ...
      description:
        'Maintain regular reading habit focused on professional development',
    ...
    },
    {
      ...
      description:
        'Complete relevant online courses and certifications regularly',
      areaId: 'area-continuous-learning',
      status: TaskStatus.PENDING,
      priority: TaskPriority.MEDIUM,
    },
    ...
    },
    {
      ...
      description:
        'Expand technical skills by learning additional programming languages',
      areaId: 'area-continuous-learning',
      status: TaskStatus.PENDING,
      priority: TaskPriority.MEDIUM,
    },
    {
      ...
      description:
        'Read books and take courses on leadership and organizational behavior',
      areaId: 'area-continuous-learning',
      status: TaskStatus.PENDING,
      priority: TaskPriority.LOW,
    },
    {
      ...
      description:
        'Learn about related disciplines and interdisciplinary knowledge',
      areaId: 'area-continuous-learning',
      status: TaskStatus.PENDING,
      priority: TaskPriority.LOW,
    },
    {
      ...
      description:
        'Share learnings through blogging, speaking, or teaching others',
      areaId: 'area-continuous-learning',
      status: TaskStatus.PENDING,
      priority: TaskPriority.LOW,
    },
    {
      ...
      description:
        'Maintain learning journal to reflect on experiences and insights',
      areaId: 'area-continuous-learning',
      status: TaskStatus.PENDING,
      priority: TaskPriority.LOW,
    },
